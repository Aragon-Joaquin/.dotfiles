...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>g', group = '[G]itStatus', mode = { 'n', 'v' } },
      },
    },
  },
  ...
  --NOTE: i've changed all of these plugins paths. use it as example
  --require 'lua.custom.plugins.debug',
